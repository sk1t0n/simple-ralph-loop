...
# запустить скрипт в многословном режиме (показывать в консоли вывод команды AI-агента) и с AI-агентом по умолчанию
...
Если запускать `ralph.sh` из другого репозитория нужно добавить `tasks.txt` в `.gitignore`, чтобы избежать дублирования задач.
